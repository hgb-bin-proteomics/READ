...
features:
  - title: Installation
    icon: 📥
    details: How to easily install READ!
    link: /docs/docs_install
    linkText: View
  - title: Usage
    icon: 📝
    details: Step-by-step instructions on how to use READ!
    link: /docs/docs_usage
    linkText: View
  - title: Configuration
    icon: 🛠️
    details: How to configure READ for your data!
    link: /docs/docs_config
    linkText: View
  - title: Output
    icon: 📊
    details: What results you can expect from READ!
    link: /docs/docs_output
    linkText: View
  - title: Contact
    icon: ℹ️
    details: Where to get help!
    link: /contact
    linkText: View
---
