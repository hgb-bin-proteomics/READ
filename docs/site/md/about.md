...
the TMT Resolution GUI Tool \[[publication](https://doi.org/10.1038/s41467-025-60022-x)\] (see also [Usage](/docs_usage)). Quantification is additionally quality controlled by optionally several filters including precursor co-isolation purity, reporter ion resolution,
...
which can be downloaded [here](https://github.com/hgb-bin-proteomics/READ/releases). In-depth information on how to install and run **READ** can be found in the [Installation](/docs_install) section.
