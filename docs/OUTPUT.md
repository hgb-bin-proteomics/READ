...
- `{psm_table_name}_purity_tmt_quant.txt` and `{psm_table_name}_purity_tmt_quant.parquet`:
...
- `{psm_table_name}_purity_tmt_quant_conditions.txt` and `{psm_table_name}_purity_tmt_quant_conditions.parquet`:
...
- `{protein_table_name}_purity_tmt_quant.txt` and `{protein_table_name}_purity_tmt_quant.parquet`:
...
- `{main_report}_purity_tmt_quant.csv` and `{main_report}_purity_tmt_quant.parquet`:
